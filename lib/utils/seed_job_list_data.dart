...
Future<void> seedJobListData() async {
  ...
  final sampleJobs = [
    JobListItem(
      ...
      amount: 1146.00,
      client: 'Max (Jawitz)',
      jobStatusId: JobListStatus.orderConfirmedNotPaid.customStatusId,
    ...
    JobListItem(
      ...
      jobStatusId: JobListStatus.jobUnderWay.customStatusId,
    ...
    JobListItem(
      ...
      jobStatusId: JobListStatus.jobDone.customStatusId,
    ...
    JobListItem(
      ...
      jobStatusId: JobListStatus.reportCompliled.customStatusId,
    ...
    JobListItem(
      ...
      jobStatusId: JobListStatus.outstanding.customStatusId,
      jobType: JobType.junkCollection,
    ...
    JobListItem(
      ...
      jobStatusId: JobListStatus.invoiceSent.customStatusId,
