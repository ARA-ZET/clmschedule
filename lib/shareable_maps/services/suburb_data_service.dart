...
class SuburbDataService {
  ...
  Future<void> saveDelta(List<WorkSuburb> current) async {
    ...
    final editedPolygons = current.where((s) {
  ...
  Future<List<WorkSuburb>> _applyDelta(List<WorkSuburb> base) async {
    ...
    final editedRaw =
        (data['editedPolygons'] as List<dynamic>? ?? []).cast<Map<String, dynamic>>();
    ...
    final addedRaw =
        (data['addedPolygons'] as List<dynamic>? ?? []).cast<Map<String, dynamic>>();
    ...
    final metaRaw =
        (data['metaOverrides'] as List<dynamic>? ?? []).cast<Map<String, dynamic>>();
    ...
    final legacyRaw =
        (data['overrides'] as List<dynamic>? ?? []).cast<Map<String, dynamic>>();
