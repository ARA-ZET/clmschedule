...
class JobListColumnsDialog extends StatefulWidget {
  ...
  @override
  State<JobListColumnsDialog> createState() => _JobListColumnsDialogState();
}

class _JobListColumnsDialogState extends State<JobListColumnsDialog> {
  ...
  Widget build(BuildContext context) {
    return Consumer<JobListPreferencesProvider>(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: ListView(
                    children:
                        preferences.columnVisibility.keys.map((columnKey) {
                      final isVisible =
